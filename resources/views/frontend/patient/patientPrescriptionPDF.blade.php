				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							...
							<h2 class="breadcrumb-title">Prescription Detail</h2>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-md-7 col-lg-8 col-xl-9">							
							<div class="row text-right" >
								<div class="col">
									...
									<a href="{{ route('patient.own.prescription.print',[$prescription->id]) }}" target="_blank" title="Print The Prescription" class="btn btn-sm bg-info">
										<i class="fas fa-print"></i> Print
									</a>
									<a href="{{ route('patient.own.prescription.PDF',[$prescription->id]) }}" target="_blank" title="Download PDF of this Prescription" class="btn btn-sm bg-success">
