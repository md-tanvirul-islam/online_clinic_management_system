...
<head>
    ...
    @stack('otherHeaderInfo')
    
    <title> @yield('title')</title>

    <!-- Custom fonts for this template-->
    <link href="{{ asset('ui/backend') }}/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            @include('backend.layouts.partials.tob-bar')
...
<script src="{{ asset('ui/backend') }}/jquery-easing/jquery.easing.min.js"></script>
